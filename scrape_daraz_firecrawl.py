# Filename: scrape_daraz3.py
# Place in: Scrap_Assignment/scrap_crawl4ai
# Requirements: pip install firecrawl-py pymongo pydantic python-dotenv beautifulsoup4
# Environment variables: MONGODB_URI, FIRECRAWL_API_KEY
...
async def main():
    ...
    test_url = "https://docs.firecrawl.dev"  # Test URL to verify Firecrawl

    # MongoDB setup
    client = MongoClient(os.getenv("MONGODB_URI"))
    db = client["daraz_scraping"]
    products3_collection = db["products3"]  # New collection

    # Test connection
    products3_collection.insert_one({"test": "connection"})
    print("MongoDB test documents:")
    print("- products3:", products3_collection.find_one({"test": "connection"}))
    ...
    # Test Firecrawl with a known URL
    ...
    for page_num in range(1, max_pages + 1):
        ...
        try:
            ...
            # Save raw HTML and Markdown (removed file writing)
            ...
            for p in page_products:
                ...
                try:
                    validated = Product(**p).model_dump()  # Updated to model_dump for Pydantic v2
